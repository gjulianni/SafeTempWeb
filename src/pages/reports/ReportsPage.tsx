...
const handleShare = async (id: number) => {
  ...
  return (
    <div className="flex h-screen bg-[#f8f9fc] overflow-hidden p-8 ">
        <Navbar />
      <aside className="w-[400px] bg-white border-r border-gray-100 flex flex-col shadow-xl z-10 mt-20">
      ...
      <main className="flex-1 overflow-y-auto bg-[#f8f9fc] p-10 relative mt-10">
              ...
              <div className="bg-white p-10 rounded-[3rem] shadow-sm border border-gray-100">
                ...
                <div className="flex justify-between items-start mb-2 border-b border-gray-50 pb-8">
                 ...
                 <div className='flex justify-between gap-2 items-center mb-6'>
                    <img src={logost} className='max-w-[20%]'/>
                  ...
                  <div className='h-[1px] bg-[#e7e7e7] mb-5 mt-5'></div>

                {/* Grid de Estatísticas do Resumo JSON */}
                ...
                <div className="flex items-center justify-between p-6 bg-white/50 backdrop-blur-sm border border-gray-100 rounded-[2rem] shadow-sm mb-8">
  <div className="flex flex-col">
    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-brand-purple mb-1">
      Gestão de Dados
    </span>
  ...
  <div className="flex items-center gap-3">
    <button
     ...
     className="group flex items-center cursor-pointer gap-3 px-6 py-3 bg-[#ff3838] text-white rounded-2xl font-black text-[11px] uppercase tracking-widest shadow-lg shadow-red-500/20 hover:bg-[#e63e3e] hover:scale-105 active:scale-95 transition-all disabled:opacity-50"
    >
      {isDownloading.pdf ? (
        <LuLoader size={18} className="animate-spin" />
      ) : (
        <LuFileText size={18} className="group-hover:rotate-12 transition-transform" />
      )}
      <span>PDF</span>
    </button>
    <button
     ...
     className="group flex items-center cursor-pointer gap-3 px-6 py-3 bg-[#27ae60] text-white rounded-2xl font-black text-[11px] uppercase tracking-widest shadow-lg shadow-green-600/20 hover:bg-[#219150] hover:scale-105 active:scale-95 transition-all disabled:opacity-50"
    >
      {isDownloading.csv ? (
        <LuLoader size={18} className="animate-spin text-brand-purple" />
      ) : (
        <LuDownload size={18} />
      )}
      <span>CSV</span>
    ...
    className="flex items-center cursor-pointer justify-center w-12 h-11 bg-[#3498db] text-white rounded-2xl shadow-lg shadow-blue-500/20 hover:bg-[#2980b9] hover:scale-110 active:scale-90 transition-all disabled:opacity-50"
      ...
      {isDownloading.share ? (
        ...
        <LuShare2 size={20} />
            ...
            <div className="h-full flex flex-col items-center justify-center text-gray-300">
              ...
              <p className="font-bold">Selecione um relatório para visualizar os detalhes</p>
            </div>
          )}
        </AnimatePresence>
      </main>
