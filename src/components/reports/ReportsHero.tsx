...
const [remember, setRemember] = useState(() => {
  ...
  return (
   <section className="flex flex-col lg:flex-row justify-center items-center gap-x-64 p-12 max-w-full mx-auto rounded-[3.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.02)] border border-gray-50 overflow-hidden relative bg-white">
      
      <div className="space-y-8 relative z-10 max-w-xl">
    <div className="space-y-4">
      <h2 className="text-5xl font-black text-brand-purple tracking-tight leading-[1.1]">
  ...
  <button 
    ...
    className={`flex-1 p-6 rounded-3xl cursor-pointer border-2 text-left transition-all group relative overflow-hidden
      ${viewMode === 'leitura' 
  ...
  >
    ...
    <p className="text-xs text-gray-400 font-medium leading-relaxed">
      Acesso completo ao conteúdo textual processado pela IA, ideal para auditorias e leitura detalhada.
    </p>
  ...
  >
    ...
    <p className="text-xs text-gray-400 font-medium leading-relaxed">
      Geração dinâmica de gráficos de telemetria com resumo das métricas, médias e picos térmicos.
    </p>
  ...
  <RememberToggle enabled={remember} onToggle={handleToggle} />
     ...
     <div className="relative h-[450px] w-[500px] hidden lg:flex items-center justify-center">
        

        <div className="absolute top-0 left-40 w-64 h-64 group animate-float-slow">
        ...
        <div className="absolute bottom-10 left-10 w-56 h-56 animate-float-delayed">
